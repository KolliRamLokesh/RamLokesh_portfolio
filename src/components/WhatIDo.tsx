        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>IoT & HARDWARE</h3>
              <h4>Building Smart Connected Systems</h4>
              <p>
                Designing IoT-powered systems that bridge the physical and digital world —
                creating automated solutions that detect, monitor, and respond to real-world
                conditions without human intervention.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">IoT Sensors</div>
                <div className="what-tags">Embedded Systems</div>
                <div className="what-tags">Automation</div>
                <div className="what-tags">Hardware Integration</div>
                <div className="what-tags">Real-time Monitoring</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Vibe Coder</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
